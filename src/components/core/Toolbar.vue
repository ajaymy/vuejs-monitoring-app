  ...
  <v-toolbar id="core-toolbar" app flat prominent style="background: #eee;">
    ...
    <v-toolbar-items>
      <v-flex align-center layout py-2>
        ...
        <router-link v-ripple class="toolbar-items" to="/py-script">
          <v-icon color="tertiary">mdi-application</v-icon>
        </router-link>
        <router-link v-ripple class="toolbar-items" to="/architecture">
